  ...
  <div className="content">
    ...
    <Section id="players" title="Правила для игроков">
      ...
      <RuleTable 
        ...
        rules={[
          { violation: 'Оскорбления', code: 'М.1', punishment: '100-2500 сек мута', why: 'Оскорбления создают токсичную атмосферу' },
          { violation: 'Спам/флуд', code: 'М.2', punishment: '100-1250 сек мута', why: 'Спам мешает нормальному общению' },
          { violation: 'Упоминание читов', code: 'М.3', punishment: '100-1000 сек мута', why: 'Реклама читов провоцирует их использование' },
          { violation: 'Токсичность/провокации', code: 'М.4', punishment: '100-2500 сек мута', why: 'Провокации разжигают конфликты' }
        ]}
      />
