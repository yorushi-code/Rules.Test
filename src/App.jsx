  ...
  <div className="content">
    ...
    <Section id="players" title="Правила для игроков">
      ...
      <RuleTable 
        ...
        rules={[
          { violation: 'Упоминание читов', code: 'Ч.1', punishment: '100-1000 сек мута (1.67 минуты)', why: 'Реклама читов провоцирует их использование' },
          { violation: 'Спам/флуд', code: 'Ч.2', punishment: '100-1250 сек мута (20.83 минуты)', why: 'Спам мешает нормальному общению' },
          { violation: 'Оскорбления/токсичность/провокации', code: 'Ч.3', punishment: '100-2500 сек мута (41.67 минуты)', why: 'Оскорбления создают токсичную атмосферу, провокации разжигают конфликты' },
        ]}
      />
